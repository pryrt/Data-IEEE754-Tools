...
use strict;
use Test::More;
use Data::IEEE754::Tools qw/:constants :floatingpoint/;

sub convert { my $f = \&{ shift @_ }; return $f->(), to_hex_floatingpoint( $f->() ); }

printf("    %-20s # to_hex_floatingpoint(%-+20e) = %s\n", $_, convert($_)) foreach ( qw(
    POS_ZERO
    POS_DENORM_SMALLEST
    POS_DENORM_BIGGEST
    POS_NORM_SMALLEST
